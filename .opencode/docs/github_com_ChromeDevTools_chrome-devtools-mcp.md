...
> Cached: 2026-07-20T09:09:19.471Z
...
A [CLI](/ChromeDevTools/chrome-devtools-mcp/blob/main/docs/cli.md) is also provided for use without MCP.
...
> 
[!TIP]
If the plugin installation fails with a `Failed to clone repository` error (e.g., HTTPS connectivity issues behind a corporate firewall), see the [troubleshooting guide](/ChromeDevTools/chrome-devtools-mcp/blob/main/docs/troubleshooting.md#claude-code-plugin-installation-fails-with-failed-to-clone-repository) for workarounds, or use the CLI installation method above instead.
  ...
  Codex
  Follow the [configure MCP guide](https://developers.openai.com/codex/mcp/#configure-with-the-cli)
...
See the [docs](https://docs.x.ai/build/features/skills-plugins-marketplaces) for more options
...
Your MCP client should open the browser 
