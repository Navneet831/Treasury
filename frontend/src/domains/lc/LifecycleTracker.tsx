          ...
          {data.map((step, idx) => (
            <React.Fragment key={idx}>
              <div
                ...
                className={`w-full bg-white border-l-4 ${stageColors[idx % stageColors.length]} rounded-xl p-5 shadow-sm hover:shadow-md cursor-pointer transition-all group relative overflow-hidden active:scale-[0.99]`}
